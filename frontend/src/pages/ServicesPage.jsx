        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {filteredServices.map((service) => (
            <div
              ...
              className="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 flex flex-col gap-4 relative transition-opacity"
              style={{ opacity: service.isActive ? 1 : 0.55 }}
            >
              <div className="flex items-start justify-between gap-2">
                <span
                  className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-bold text-white w-fit"
